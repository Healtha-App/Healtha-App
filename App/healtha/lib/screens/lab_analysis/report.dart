...
class _ReportState extends State<Report> {
  ...
  Future<void> _translateReport() async {
    ...
    String promptWithLanguage = _isTranslated ? _getTranslatedPrompt() : _getOriginalPrompt();
      ...
      Expanded(
        child: SingleChildScrollView(
          ...
          floatingActionButton: Stack(
            children: [
              Positioned(
                top: MediaQuery.of(context).size.height * 0.02, // Adjust position based on screen size
                left: MediaQuery.of(context).size.width * 0.2, // Adjust position based on screen size
                child: Visibility(
                  ...
                  child: Container(
                    ...
                    child: Center(
                      child: Icon(
                        ...
                        size: 20,
                        color: _isVolumeHigh ? Colors.white : const Color(0xff7c77d1),
                      ),
                    ),
                  ),
                ),

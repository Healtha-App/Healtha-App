...
class Calcium extends StatelessWidget {
  ...
  Future<LabTest> fetchLabTest() async {
    ...
    if (response.statusCode == 200) {
      ...
      if (labTests.isNotEmpty && labTests.length >= 90) { // Check if there are at least 3 lab tests
        Map<String, dynamic> naLabTest = labTests[89]; // Accessing the third lab test using index 2

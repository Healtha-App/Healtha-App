...
class Urinalysis extends StatelessWidget {
  ...
  Future<LabTest> fetchLabTest() async {
    ...
    if (response.statusCode == 200) {
      ...
      if (labTests.isNotEmpty && labTests.length >= 3) { // Check if there are at least 3 lab tests
        Map<String, dynamic> thirdLabTest = labTests[2]; // Accessing the third lab test using index 2
